...
- Or changing the velocity scales for this keyboard driver in `forward_keyboard.yaml <https://github.com/lbr-stack/lbr_fri_ros2_stack/blob/humble/lbr_demos/lbr_moveit/config/forward_keyboard.yaml>`_:octicon:`link-external`.
